...
if run_hga:
    ...
    for _ in range(NO_OF_TEST):
        ...
        average_excuted_time_w_ls.append(time_with_ls)
...
if run_hga:
    print("Travel time with local search: ", travel_time_w_ls)
if run_aco:
...
if run_hga:
    print("Time executed with local search: ", average_excuted_time_w_ls)
if run_aco:
...
if run_hga:
    print("Average Time executed with local search: ", sum(average_excuted_time_w_ls)/NO_OF_TEST)
if run_aco:
